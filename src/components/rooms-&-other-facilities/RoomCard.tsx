...
const RoomCard: React.FC<RoomCardProps> = ({ image, title, hoverText, link }) => {
  return (
    <Link
      href={link || "#"}
      className="block bg-[#F4F9FD] overflow-hidden text-center transition-transform duration-300 hover:scale-[1.02]"
    >
      {/* Image Section */}
      <div className="relative group">
        ...
        />
        {/* Overlay on Hover */}
        <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-80 flex items-center justify-center transition-opacity duration-300 py-30">
