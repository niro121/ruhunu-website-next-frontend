...
const FacilityCard: React.FC<FacilityCardProps> = ({ image, title, content }) => {
  return (
    <div className="flex flex-col bg-white shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden h-106">
      {/* Image Section */}
        <div className="relative w-full h-71 flex-shrink-0">
      ...
      {/* Scrollable Text Section */}
        <div className="flex flex-col flex-1 overflow-scroll no-scrollbar py-6 px-3 md:px-0 text-center">
            <h3 className="text-md font-bold mb-3 text-[#122739]" >
                {title}
            </h3>
